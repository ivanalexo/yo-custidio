...
export class TokenService {
    ...
    constructor(
        ...
        this.defaultUploadTokens = this.configService.get<number>('app.tokens.upload.default', 10);
        this.resetInterval = this.configService.get<number>('app.tokens.upload.resetInterval', 24 * 60 * 60 * 1000);
    }
